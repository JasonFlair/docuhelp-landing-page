...
function Hero () {
  return (
    <div className="hero-section relative bg-docuhelpHeroBg h-[80vh] lg:h-screen flex flex-col items-center justify-center overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-1/4 lg:h-1/3 flex flex-col gap-6 items-center justify-center z-10"> {/* Updated z-index here */}
        <h1 className="px-4 w-[100%] lg:w-2/3 text-[40px] lg:text-[64px] mt-[450px] lg:mt-[300px] font-extrabold text-center">DOCUHELP <span className="text-docuhelpBlue-100 mb-6">WRITES</span> BUSINESS DOCUMENTS.</h1>
